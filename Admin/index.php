...
<head>
    ...
    <title>管理后台 - <?php echo $conf_config['site']; ?></title>
        ...
        <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right" style="margin-right:25px;">
          ...
          <li class="layui-nav-item" lay-unselect>
            ...
            <dl class="layui-nav-child layui-anim layui-anim-upbit">
                ...
                <dd>
                    <a href="javascript:;" onclick="OutOrder()" class="login-out">退出登录</a>
                </dd>
            </dl>
          </li>
        </ul>
        ...
        <div class="layui-side-scroll">
          ...
          <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
            <li data-name="home" class="layui-nav-item layui-nav-itemed">
              ...
              <dl class="layui-nav-child">
                ...
                <dd data-name="console">
                  <a lay-href="Inter.php">接口管理</a>
                </dd>
                <dd data-name="console">
                  <a lay-href="Addapi.php">接口页面</a>
                </dd>
                <dd data-name="console">
                  <a lay-href="Addreturn.php">返回参数</a>
                </dd>
                <dd data-name="console">
                  <a lay-href="Adderror.php">错误参数</a>
                </dd>
              </dl>
            </li>
            <li data-name="user" class="layui-nav-item">
              ...
              <dl class="layui-nav-child">
                <dd data-name="console">
                  <a lay-href="management.php">用户管理</a>
                </dd>
              </dl>
            </li>
          </ul>
