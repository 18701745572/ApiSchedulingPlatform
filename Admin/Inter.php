            ...
            <div class="layui-card">
                <div class="layui-card-header"><i class="fa fa-fire icon"></i>
                    ...
                    <div style="display:-webkit-inline-box;float:right;">
                        ...
                        <a href="publish_api.php" class="layui-btn layui-btn-sm layui-btn-warm" style="margin:6px;">发布接口</a>
                    </div>
                </div>
                    ...
                    <table class="layui-table" style="margin: 0 auto;">
                        <tbody>
                            <tr>
                                ...
                                <td style="width:45%">
                                    <div class="layui-table-cell" align="center">主要用处</div>
                                </td>
                                <td style="width:10%">
                                    <div class="layui-table-cell" align="center">调用渠道</div>
                                </td>
                                <td style="width:10%">
                                    <div class="layui-table-cell" align="center">使用次数</div>
                                </td>
                            ...
                            <?php 
                                ...
                                //读取指定记录
                                $result = mysqli_query($con,"select * from `sc_inter` order by id limit $offset,$pagesize",$connect);
                                ...
                                while($row=mysqli_fetch_array($result)){
                                    ...
                                    echo '<td><div class="layui-table-cell" align="center" id="neirong'.$row['id'].'">'.$row['neirong'].'</div></td>';
                                    echo '<td><div class="layui-table-cell" align="center" id="channel'.$row['id'].'">'.$row['channel'].'</div></td>';
                                    echo '<td><div class="layui-table-cell" align="center" id="channel'.$row['id'].'">'.$row['counter'].'</div></td>';
...
<div style="text-align:center;color:#009688;margin:0 0 20px 0;">© Copyright 2024 - 2024 | 免费API调度平台 | All Rights Reserved </div>
