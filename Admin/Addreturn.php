                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="name" type="text" autocomplete="off" aria-describedby="name" name="name" value=""
                                placeholder="url">
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="type" type="text" autocomplete="off" aria-describedby="type" name="type" value="string"
                                placeholder="string">
                        </div>
                    </div>
                    <div class="col-lg-5">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="explain" type="text" autocomplete="off" aria-describedby="explain" name="explain" value=""
                    ...
                    <table class="layui-table" style="margin: 0 auto;">
                        <tbody>
                            <tr>
                                ...
                                <td style="width:10%">
                                    <div class="layui-table-cell" align="center"><span>接口名称</span>
                                    </div>
                                </td>
                                <td style="width:10%">
                            ...
                            <?php 
                                ...
                                //计算一共多少记录，用于计算页数
                                $rs = mysqli_query($con,"select count(*) from sc_errturn where errturn='1'");
                                ...
                                //读取指定记录
                                $result = mysqli_query($con,"select * from `sc_errturn` where errturn='1' order by zid limit $offset,$pagesize",$connect);
                                ...
                                if($page==1){//处于首页的话
                                    ...
                                    $tempx=$page+1;
                                    echo "<a class='page-numbers' href='Addreturn.php?page=".$tempx." '>下一页</a>";
                                    echo "<a class='page-numbers' href='Addreturn.php?page=".$pages."'>末页</a>";
                                }else if($page==$pages){//处于末页的话
                                    echo "<div style='margin:10px 0;'><a class='page-numbers' href='Home.php?page=1'>首页</a>";
                                    $temps=$page-1;
                                    echo "<a class='page-numbers' href='Addreturn.php?page=".$temps."'>上一页</a>";
                                    ...
                                    echo "<div style='margin:10px 0;'><a class='page-numbers' href='Addreturn.php?page='1''>首页</a>";
                                    $temps=$page-1;
                                    echo "<a class='page-numbers' href='Addreturn.php?page=".$temps."'>上一页</a>";
                                    $tempx=$page+1;
                                    echo "<a class='page-numbers' href='Addreturn.php?page=".$tempx." '>下一页</a>";
...
function tiao(){
    ...
    if(page>'0'&&page<=pages){
        parent.document.getElementById("home").src="Addreturn.php?page="+page;
    }else{
